...
public class ConfirmNetwork extends AbstractWizardPage {
	...
	public ConfirmNetwork() {
		...
		add(new JLabel(rsc_bdl.getString("SETTINGS.NETWORK.WIZARD.CONFIRM.NAME")), new GridBagConstraints(1, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
		add(new JLabel(rsc_bdl.getString("SETTINGS.NETWORK.WIZARD.CONFIRM.URL")), new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0));
